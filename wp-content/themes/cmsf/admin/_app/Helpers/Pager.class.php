...
class Pager {
    ...
    private function getSyntax() {
        ...
        if ($this->Rows > $this->Limit):
            ...
            $this->Paginator = "<ul class=\"paginator col-lg-12\">";
            $this->Paginator .= "<li><a title=\"Primeira Pagina\" href=\"{$this->Link}1\"><i class=\"fa fa-fast-backward\" aria-hidden=\"true\"></i></a></li>";
            ...
            $this->Paginator .= "<li><a title=\"Ultima Pagina\" href=\"{$this->Link}{$Paginas}\"><i class=\"fa fa-fast-forward\" aria-hidden=\"true\"></i></a></li>";
            $this->Paginator .= "</ul>";
        endif;
    }
