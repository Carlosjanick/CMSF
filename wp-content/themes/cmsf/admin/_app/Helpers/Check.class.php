...
class Check {
    ...
    public static function CatByName($CategoryName) {
        $read = new Read;
        $read->ExeRead('fg_categories', "WHERE category_name = :name", "name={$CategoryName}");
        if ($read->getRowCount()):
    ...
    /**
     * <b>Utilizadores Online:</b> Ao executar este HELPER, ele automaticamente deleta os usuários expirados. Logo depois
    ...
    public static function UserOnline() {
        ...
        $deleteUserOnline->ExeDelete('fg_siteviews_online', "WHERE online_endview < :now", "now={$now}");

        $readUserOnline = new Read;
        $readUserOnline->ExeRead('fg_siteviews_online');
